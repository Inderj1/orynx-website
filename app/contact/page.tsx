...
import { ArrowUpRight, Check, Mail, Phone, Calendar, MessageSquare } from "lucide-react"
...
const COMPANY_PHONE_DISPLAY = "07985 309592"
const COMPANY_PHONE_TEL = "+447985309592"
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: `New contact form submission${payload.name ? ` — ${payload.name}` : ""}`,
            ...
            {submitted ? (
              ...
              <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center gap-2 h-12 px-6 rounded-full bg-accent-orange text-white text-[15px] font-semibold hover:bg-accent-orange-deep transition-colors duration-150 group disabled:opacity-60 disabled:cursor-not-allowed"
                >
          ...
          <div className="lg:col-span-5">
            ...
            <div className="mt-10 pt-8 border-t border-rule">
              ...
              <a
                ...
                className="font-display font-semibold text-ink text-xl hover:text-brand-blue transition-colors block"
              >
                {COMPANY_EMAIL}
              </a>
              ...
              <p className="text-ink-soft text-sm mt-4">Edinburgh, Scotland</p>
            </div>
          </div>
        </div>
      </section>
