...
function IsometricBuilding({
  ...
  const colorSets = {
    coral: {
      ...
      left: "hsl(20 60% 62%)",
      right: "hsl(20 60% 52%)",
      glow: "hsl(20 60% 72% / 0.4)",
      border: "hsl(20 60% 82% / 0.6)"
    },
    teal: {
      top: "hsl(24 70% 50%)",
      left: "hsl(24 70% 40%)",
      right: "hsl(24 70% 30%)",
      glow: "hsl(24 70% 50% / 0.4)",
      border: "hsl(24 70% 70% / 0.6)"
    },
    gold: {
      top: "hsl(42 85% 55%)",
      left: "hsl(42 85% 45%)",
      right: "hsl(42 85% 35%)",
      glow: "hsl(42 85% 55% / 0.4)",
      border: "hsl(42 85% 75% / 0.6)"
    },
    slate: {
      top: "hsl(218 46% 30%)",
      left: "hsl(218 46% 24%)",
      right: "hsl(218 46% 18%)",
      glow: "hsl(218 46% 50% / 0.3)",
      border: "hsl(218 46% 50% / 0.4)"
    },
  }
...
function ServerRack({ x, y, delay = 0 }: { x: number; y: number; delay?: number }) {
  return (
    ...
    >
      {/* Shadow */}
      <ellipse cx={x + 25} cy={y + 75} rx={30} ry={8} fill="hsl(218 46% 14% / 0.2)" />
      
      {/* Rack body */}
      <rect x={x} y={y} width={50} height={70} rx={4} fill="hsl(218 46% 18%)" stroke="hsl(218 46% 30% / 0.5)" strokeWidth="1" />
      
      {/* Server units */}
      {[0, 1, 2, 3].map((i) => (
        <motion.g key={i}>
          <rect x={x + 5} y={y + 8 + i * 15} width={40} height={12} rx={2} fill="hsl(218 46% 25%)" stroke="hsl(218 46% 35% / 0.3)" strokeWidth="0.5" />
          <motion.circle
            cx={x + 12}
            cy={y + 14 + i * 15}
            r={2}
          ...
          />
          <rect x={x + 28} y={y + 12 + i * 15} width={12} height={4} rx={1} fill="hsl(218 46% 35% / 0.5)" />
        </motion.g>
      ))}
    </motion.g>
  )
...
function IsometricPlatform({ delay = 0 }: { delay?: number }) {
  return (
    ...
    >
      {/* Ambient shadow */}
      <ellipse cx="320" cy="270" rx="140" ry="50" fill="hsl(218 46% 14% / 0.1)" style={{ filter: "blur(20px)" }} />
      
      {/* Contact shadow */}
      <ellipse cx="320" cy="250" rx="120" ry="35" fill="hsl(218 46% 14% / 0.15)" style={{ filter: "blur(8px)" }} />
      
      {/* Main platform */}
      <motion.path
        d="M200 180 L320 120 L440 180 L320 240 Z"
        fill="hsl(218 46% 14%)"
        stroke="hsl(218 46% 24% / 0.5)"
        strokeWidth="1"
      />
      {/* Platform depth left */}
      <motion.path
  ...
  return (
    <div ref={containerRef} className="relative w-full h-full flex items-center justify-center">
      ...
      <div 
        ...
        style={{
          background: `
            radial-gradient(circle at 50% 50%, transparent 0%, hsl(30 15% 98%) 70%),
            radial-gradient(circle, hsl(218 30% 88% / 0.1) 1px, transparent 1px)
          `,
        ...
        >
          <defs>
            ...
            <radialGradient id="glowGradient" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="hsl(24 70% 50%)" stopOpacity="0.12" />
              <stop offset="50%" stopColor="hsl(24 70% 50%)" stopOpacity="0.05" />
          ...
          >
            <ellipse cx="360" cy="165" rx="50" ry="15" fill="hsl(218 46% 14% / 0.1)" style={{ filter: "blur(8px)" }} />
            <path d="M280 140 L360 100 L440 140 L360 180 Z" fill="hsl(218 46% 20%)" stroke="hsl(218 46% 30% / 0.4)" strokeWidth="0.5" />
            <path d="M280 140 L280 155 L360 195 L360 180 Z" fill="hsl(218 46% 26%)" stroke="hsl(218 46% 36% / 0.3)" strokeWidth="0.5" />
            <path d="M360 180 L360 195 L440 155 L440 140 Z" fill="hsl(218 46% 30%)" stroke="hsl(218 46% 40% / 0.3)" strokeWidth="0.5" />
          </motion.g>
